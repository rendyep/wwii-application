...
class ReportGeneralInspectionPembahananPanelPrintAction
{
    ...
    {
        $domain = 'WWII\Domain\Erp\QualityControl\GeneralInspection\PembahananPanelInspection';

        $result = $this->entityManager
            ->getRepository('WWII\Domain\Erp\QualityControl\GeneralInspection\PembahananPanelInspection')
    ...
    public function render(array $result = null)
    {
        ...
        include('/view/report_general_inspection_pembahanan_panel_print.phtml');
    }
}
