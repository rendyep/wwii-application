...
class ReportGeneralInspectionFinishingGraphAction
{
    ...
    public function dispatchFilter($params)
    {
        if (! empty($params)) {
            ...
            if (empty($errorMessages)) {
                ...
                $dailyInspection->andWhere('finishingInspection.tanggalInspeksi = :tanggal')
    ...
    protected function render(array $result = null)
    {
        ...
        include('view/report_general_inspection_finishing_graph.phtml');
