...
class ReportGeneralInspectionPembahananPanelGraphAction
{
    ...
    public function dispatchFilter($params)
    {
        if (! empty($params)) {
            ...
            if (empty($errorMessages)) {
                ...
                $dailyInspection->andWhere('pembahananPanelInspection.tanggalInspeksi = :tanggal')
    ...
    protected function render(array $result = null)
    {
        ...
        include('view/report_general_inspection_pembahanan_panel_graph.phtml');
