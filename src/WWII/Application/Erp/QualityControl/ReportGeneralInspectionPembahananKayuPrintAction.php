...
class ReportGeneralInspectionPembahananKayuPrintAction
{
    ...
    {
        $domain = 'WWII\Domain\Erp\QualityControl\GeneralInspection\PembahananKayuInspection';

        $result = $this->entityManager
            ->getRepository('WWII\Domain\Erp\QualityControl\GeneralInspection\PembahananKayuInspection')
    ...
    public function render(array $result = null)
    {
        ...
        include('/view/report_general_inspection_pembahanan_kayu_print.phtml');
    }
}
