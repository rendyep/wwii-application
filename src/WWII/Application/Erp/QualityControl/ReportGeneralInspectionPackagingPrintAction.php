...
class ReportGeneralInspectionPackagingPrintAction
{
    ...
    {
        $domain = 'WWII\Domain\Erp\QualityControl\GeneralInspection\PackagingInspection';
    ...
    public function render(array $result = null)
    {
        ...
        include('/view/report_general_inspection_packaging_print.phtml');
    }
}
