...
class ReportGeneralInspectionWhitewoodGraphAction
{
    ...
    public function dispatchFilter($params)
    {
        if (! empty($params)) {
            ...
            if (empty($errorMessages)) {
                ...
                $dailyInspection->andWhere('whitewoodInspection.tanggalInspeksi = :tanggal')
    ...
    protected function render(array $result = null)
    {
        ...
        include('view/report_general_inspection_whitewood_graph.phtml');
