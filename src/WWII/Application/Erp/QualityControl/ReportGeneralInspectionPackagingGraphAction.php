...
class ReportGeneralInspectionPackagingGraphAction
{
    ...
    public function dispatchFilter($params)
    {
        if (! empty($params)) {
            ...
            if (empty($errorMessages)) {
                ...
                $dailyInspection->andWhere('packagingInspection.tanggalInspeksi = :tanggal')
    ...
    protected function render(array $result = null)
    {
        ...
        include('view/report_general_inspection_packaging_graph.phtml');
